...
namespace FluentMvvm
{
    ...
    public abstract class FluentViewModelBase : IPropertyGetExpression, IPropertySetExpression, IConditionalExpression, IDependencyExpression, INotifyPropertyChanged
    {
        ...
        protected internal virtual void AfterSet<T>(T value, string propertyName) { }
        ...
        /// </exception>
        public Boolean GetBoolean([CallerMemberName] string propertyName = "")
        {
            return this.BackingFields.GetBoolean(propertyName);
        }
        ...
        /// </exception>
        public Single GetSingle([CallerMemberName] string propertyName = "")
        {
            return this.BackingFields.GetSingle(propertyName);
        }
        ...
        /// </exception>
        public Int16 GetInt16([CallerMemberName] string propertyName = "")
        {
        ...
        /// </exception>
        public UInt16 GetUInt16([CallerMemberName] string propertyName = "")
        {
        ...
        /// </exception>
        public Int32 GetInt32([CallerMemberName] string propertyName = "")
        {
        ...
        /// </exception>
        public UInt32 GetUInt32([CallerMemberName] string propertyName = "")
        {
        ...
        /// </exception>
        public Int64 GetInt64([CallerMemberName] string propertyName = "")
        {
        ...
        /// </exception>
        public UInt64 GetUInt64([CallerMemberName] string propertyName = "")
        {
        ...
        ///     there are no backing fields of type <typeparamref name="T" />.
        /// </exception>
        public IDependencyExpression Set<T>([AllowNull] T value, [CallerMemberName] string propertyName = "")
        {
            if (this.BackingFields.Set(value, propertyName))
            {
                Debug.Assert(!String.IsNullOrWhiteSpace(propertyName));

                this.AfterSet(value, propertyName);
